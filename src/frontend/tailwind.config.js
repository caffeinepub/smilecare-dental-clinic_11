  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        dental: { navy: "#0E3A53", teal: "#1B5A73", green: "#2FAE66", accent: "#2C7DA0", tint: "#EAF3FA", border: "#E6EDF3" },
      },
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 2px)", sm: "calc(var(--radius) - 4px)" },
      boxShadow: { xs: "0 1px 2px 0 rgba(0,0,0,0.05)", card: "0 4px 24px rgba(14,58,83,0.1)", "card-hover": "0 12px 40px rgba(14,58,83,0.18)" },
      keyframes: {
